...
function config(Env) {
    ...
    return {
        ...
        telegramAnnaRatioAlertsChatId:Env?.TELEGRAM_ANNA_RATIO_ALERTS_CHAT_ID,
        ...
        telegramAnnaBankAlertChatId:Env?.TELEGRAM_ANNA_BANK_ALERT_CHAT_ID,
        telegramDuplicateDisputeChatId:Env?.TELEGRAM_DISPUTE_DUPLICATE_CHAT_ID,
        telegramAnnaDuplicateDisputeChatId:Env?.TELEGRAM_ANNA_DISPUTE_DUPLICATE_CHAT_ID,
        ...
        telegramAnnaEntryResetChatId:Env?.TELEGRAM_ANNA_ENTRY_RESET_HISTORY_CHAT_ID,
